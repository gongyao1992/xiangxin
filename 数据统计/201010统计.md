...
graph LR
%% 例子
YuanHao["产品"] -->|"数据任务"| Pingguo["测试"]
Pingguo -->|"确定的需求"| DaGong["开发"]
YuanHao ==>JinJi("紧急任务") ==> DaGong
DaGong -->|"需要校验的数据"| Pingguo
Pingguo -->|"校验之后的数据"| YuanHao

DaGong ==> JinJi ==>|"紧急数据"| Pingguo
Pingguo ===|"校验"| YuanHao
```
...
ErpOrder --- ErpOrderTradeType(("贸易类型"))
```
